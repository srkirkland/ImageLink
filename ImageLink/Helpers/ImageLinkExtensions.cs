...
namespace ImageLink.Helpers
{
    public static class ImageLinkExtensions
    {
        ...
        public static string ImageLink(this HtmlHelper htmlHelper, string imageName, string altText, string actionName, object routeValues, object htmlAttributes, object imageHtmlAttributes)
        {
            return ImageLink(htmlHelper /* controllerName */, imageName, altText, actionName, null, new RouteValueDictionary(routeValues), new RouteValueDictionary(htmlAttributes), new RouteValueDictionary(imageHtmlAttributes));
        }
        ...
        public static string ImageLink(this HtmlHelper htmlHelper, string imageName, string altText, string actionName, RouteValueDictionary routeValues, IDictionary<string, object> htmlAttributes, IDictionary<string, object> imageHtmlAttributes)
        {
            return ImageLink(htmlHelper /* controllerName */, imageName, altText, actionName, null, routeValues, htmlAttributes, imageHtmlAttributes);
        }
        ...
        public static string ImageLink(this HtmlHelper htmlHelper, string imageName, string altText, string actionName, string controllerName, object routeValues, object htmlAttributes, object imageHtmlAttributes)
        {
            return ImageLink(htmlHelper, imageName, altText, actionName, controllerName, new RouteValueDictionary(routeValues), new RouteValueDictionary(htmlAttributes), new RouteValueDictionary(imageHtmlAttributes));
        }

        public static string ImageLink(this HtmlHelper htmlHelper, string imageName, string altText, string actionName, string controllerName, RouteValueDictionary routeValues, IDictionary<string, object> htmlAttributes, IDictionary<string, object> imageHtmlAttributes)
        {
            if (String.IsNullOrEmpty(altText))
            {
                throw new ArgumentException(STR_NULL_OR_EMPTY, "altText");
            }
            return GenerateImageLink(htmlHelper.ViewContext.RequestContext, htmlHelper.RouteCollection /* routeName */, imageName, altText, null, actionName, controllerName, routeValues, htmlAttributes, imageHtmlAttributes);
        }

        public static string ImageLink(this HtmlHelper htmlHelper, string imageName, string altText, string actionName, string controllerName, string protocol, string hostName, string fragment, object routeValues, object htmlAttributes, object imageHtmlAttributes)
        {
            return ImageLink(htmlHelper, imageName, altText, actionName, controllerName, protocol, hostName, fragment, new RouteValueDictionary(routeValues), new RouteValueDictionary(htmlAttributes), new RouteValueDictionary(imageHtmlAttributes));
        }

        public static string ImageLink(this HtmlHelper htmlHelper, string imageName, string altText, string actionName, string controllerName, string protocol, string hostName, string fragment, RouteValueDictionary routeValues, IDictionary<string, object> htmlAttributes, IDictionary<string, object> imageHtmlAttributes)
        {
            if (String.IsNullOrEmpty(altText))
            {
                throw new ArgumentException(STR_NULL_OR_EMPTY, "altText");
            ...
            return GenerateImageLink(htmlHelper.ViewContext.RequestContext, htmlHelper.RouteCollection /* routeName */, imageName, altText, null, actionName, controllerName, protocol, hostName, fragment, routeValues, htmlAttributes, imageHtmlAttributes);
        }
        ...
        {
            return GenerateImageLink(requestContext, routeCollection /* protocol */ /* hostName */ /* fragment */, imageName, altText, routeName, actionName, controllerName, null, null, null, routeValues, htmlAttributes, imageHtmlAttributes);
        }
